...
exports.aggregateMonthlyStatsCallable = void 0;
exports.aggregateMonthlyStats = aggregateMonthlyStats;
 ...
 */
async function aggregateMonthlyStats(firebaseUid, monthStr // YYYY-MM format
) {
 ...
 */
exports.aggregateMonthlyStatsCallable = (0, https_1.onCall)({
    ...
    try {
        ...
        throw new https_1.HttpsError("internal", "Failed to aggregate monthly stats");
    }
});
//# sourceMappingURL=monthlyStats.js.map